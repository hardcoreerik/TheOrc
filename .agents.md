...
This is the single canonical copy. `.claude/AGENTS.md` is a thin pointer to
this file — edit only here, and there is no second copy to keep in sync.
...
`SwarmSession`/`ChatEngine` (commit `dc79041`). Full spec: `docs/RUNTIME_PHASE0_SPEC.md`.
