...
> Last updated: 2026-07-02 (Context Fabric CF-7 benchmark-gate contract merged in PR #16; CF-8 hard-ingestion groundwork is active).
...
### The Orc Context Fabric — effectively unbounded source memory (CF-0 through CF-7 landed; CF-8 active)
...
9. CF-8 multimodal documents, optional vector acceleration, and cross-CodeGraph links. Active first slice: parser block provenance for OCR/page/table evidence.
