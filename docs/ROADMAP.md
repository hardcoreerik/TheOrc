...
> Last updated: 2026-07-03 (Context Fabric CF-8 closeout docs merged in PR #25; CF-5 real native-model product exit remains pending).
...
### The Orc Context Fabric — effectively unbounded source memory (CF-0 through CF-8 landed; CF-5 product exit pending)
