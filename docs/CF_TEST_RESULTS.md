...
- **Rows 15-16 remain invalid historical artifacts.** §7e is root-caused as request-level
  attention-context exhaustion and a fix is implemented, but Qwen3.5-9B still has no valid
  full-scale CF-7 score until clean 120-question Q8_0 and Q4_K_M revalidation completes. The
  "16/120 Q8_0, 1/120 Q4_K_M" numbers were invalidated by the thinking-suppression bug; the
  newer 14/120 and 40/120 numbers were invalidated by §7e.
