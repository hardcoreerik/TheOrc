...
// above. S (\s): the FIXED, version-stable Unicode White_Space=Y property
// list (25 codepoints/ranges) -- NOT Python str.isspace(), which incorrectly
...
namespace orcengine::pretok_tables {
...
inline constexpr CodepointRange kLetter[] = {
    {0x41, 0x5A},
    {0x61, 0x7A},
    {0xAA, 0xAA},
    {0xB5, 0xB5},
...
inline constexpr std::size_t kLetterCount = 677;

inline constexpr CodepointRange kNumber[] = {
    {0x30, 0x39},
    {0xB2, 0xB3},
    {0xB9, 0xB9},
    {0xBC, 0xBE},
...
inline constexpr std::size_t kNumberCount = 144;

inline constexpr CodepointRange kWhiteSpace[] = {
    {0x9, 0xD},
    {0x20, 0x20},
    {0x85, 0x85},
    {0xA0, 0xA0},
...
inline constexpr std::size_t kWhiteSpaceCount = 10;
