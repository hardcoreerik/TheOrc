...
//
// The 256-entry GPT-2 byte-to-Unicode-codepoint mapping, cross-checked
// against the live tokenizers==0.22.2 oracle (ByteLevel.alphabet() set
// equality plus a direct per-byte mapped-character check for every byte
// value reachable through valid UTF-8). See DECISION_LOG.md OE-ADR-034.
#pragma once
...
inline constexpr std::uint32_t kOracleByteToCodepoint[256] = {
