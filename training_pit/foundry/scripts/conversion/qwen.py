...
try:
    _dflash_arch = gguf.MODEL_ARCH.DFLASH
except AttributeError:
    _dflash_arch = None  # gguf PyPI package older than llama.cpp repo; skip DFlash

if _dflash_arch is not None:
    @ModelBase.register("DFlashDraftModel")
    class DFlashModel(Qwen3Model):
        model_arch = _dflash_arch
